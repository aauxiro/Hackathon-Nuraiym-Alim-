...
let editPrise = document.querySelector('#edit-Prise')
let editDescr = document.querySelector('#edit-Description')
let editImage = document.querySelector('#edit-Image')
let editBtnAdd = document.querySelector('#btn-save-edit')
let examleModal = document.querySelector('#exampleModal')   
...
editBtnAdd.addEventListener('click', function(){
    ...
    if(!title || !descr || !prise || !image)return;
...
function saveEdit(editedProduct,id){
    ...
    let modal = bootstrap.Modal.getInstance(examleModal);
    modal.hide();
}
